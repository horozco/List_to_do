...
describe ListsController do
  ...
  context "All user" do
    ...
    it "Should view all create List" do
      4.times {create(:list)} 
      get :index
      assigns[:lists].should have_at_least(4).lists
      response.should render_template(:index)     
    end

    it "Should view all the information of a specific list" do
      existing_list = create(:list)
      get :show, id: existing_list.id
